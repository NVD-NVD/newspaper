        ...
        <div class="card-body py-md-4">
            <form _lpchecked="1" id="mainForm" name="mainForm">
                ...
                <div class="form-group">
                    ...
                    <div class="form-check-inline">
                        <label class="form-check-label">
                            <input type="radio" class="form-check-input account-check" name="accountType" value="reader" checked>Người đọc báo
                        </label>
                    </div>
                    <div class="form-check-inline">
                        <label class="form-check-label">
                            <input type="radio" class="form-check-input account-check" name="accountType" value="writer" id="acc-type-writer">Phóng viên (Người Viết báo)
                        </label>
                    </div>
                </div>
...
<script type="text/javascript">
    ...
    // {
    //     var checked = document.querySelector('input[name="account-type"]:checked').value();
    //     console.log(checked)
    //
    // }
</script>
